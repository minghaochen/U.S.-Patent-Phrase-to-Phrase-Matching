...
train['text_a'] = train['anchor'] + '[SEP]' + train['target'] + '[SEP]' + train['context_text']
...
class Model(nn.Module):
    def __init__(self):
        ...
        self.linear = nn.Linear(self.bert.config.hidden_size * 1, mid_size)
    ...
    def forward(self, input_ids_a, attention_mask_a,
        ...
        output = self.linear(source_embedding)
